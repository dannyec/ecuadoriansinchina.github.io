...
! function() {
    ...
    function(e) {
        ...
        t.origRender = t.render, t.render = function(n, i) {
            return e.extend(i, a), t.origRender.apply(this, arguments)
        };
                        ...
                        if (2 == t.eventPhase) {
                            if (n.leaveTransforms !== !0) {
                                ...
                                if (u && "undefined" != typeof r.meta)
                                    for (var a, l = 0; a = p[l]; ++l) o[a] = r.meta[a + "_o"] + _, e(this).css(a, o[a])
                            }
    ...
    function(e, t) {
        ...
        var t = e.split("/");
        this._url = e, this._end = t[t.length - 2], this.loading = new jsonrpc.Observable, this.loaded = new jsonrpc.Observable, this.unhandledFailure = new jsonrpc.Observable, this._loadingState = new jsonrpc.CallStack(this.loading.trigger, this.loading, this.loaded.trigger, this.loaded), this._requests = [], this._batchingMilliseconds = 10,
    ...
    function() {
        Weebly.ns = function(e, t) {
            ...
            for (var o in i) t[o] && (i[o].rpc = t[o]);
            for (var o in n)
                if (t[o]) {
                    n[o].rpc = t[o];
                    var s = n[o].relations;
